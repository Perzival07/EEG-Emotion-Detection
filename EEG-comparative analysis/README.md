...
| DEAP official source -- not used here (registration/EULA required; currently returning HTTP 503, verify before relying on it) | <https://www.eecs.qmul.ac.uk/mmv/datasets/deap/> | -- |
